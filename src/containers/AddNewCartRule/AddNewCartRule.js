...
export default class AddNewCartRule extends Component {
    render() {
      const styles = require('./addNewCartRule.scss');
      return (
        <div className="container-fluid">
    		<div className="row">
                <div className={ classNames(styles['add-new-cart-rule-view']) }>
                    ...
                    <div className={styles['panel-left']}>
                        <div className={styles['panel-content']}>
                            <p className={styles['list-menu']}>Set Cart Rule Info</p>
                            <p className={styles['list-menu']}>- End of the Bill Discount (0)</p>
                        </div>
                    </div>
                    <div className={styles['panel-right']}>
                        <div className={styles['panel-content']}>
                            <p className={styles['list-menu']}>Cart Rule Info</p>
                            <div className={ classNames(styles['control-group'], 'row') }>
                                <div className={styles['control-label']}>
                                    <label className={styles['control-label']}>Cart Rule name</label>
                                </div>
                            ...
                            <div className={ classNames(styles['control-group'], 'row') }>
                                ...
                                <div className={styles['control-optional']}>
                                    <div className={styles['content-option']}>
										 <a href="#"><i className="fa fa-plus-circle"></i>Advance Schdule Setting</a>
                                    </div>
                                </div>
                            </div>
