...
export default class ShippingGlobalFeeWithShippingFee extends Component {
    render() {
      const styles = require('./shippingGlobalFeeWithShippingFee.scss');
      return (
        <div className="container-fluid">
    		<div className="row">
                <div className={ classNames(styles['shipping-global-fee-with-shipping-fee-view']) }>
                    ...
                    <div className={styles['panel-left']}>
                        <div className={styles['panel-content']}>
                            ...
                            <ul className={styles['gwp-globle-menu']}>
                                ...
                                <li className={ classNames( styles['gwp-globle-menu-list'], styles['menu-active'] ) }><label><input type="radio">Buy amount XXX baht with shipping fee xxx baht (0)</input></label></li>
