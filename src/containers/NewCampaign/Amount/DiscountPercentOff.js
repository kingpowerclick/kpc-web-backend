                    ...
                    <div className={styles['panel-left']}>
                        <div className={styles['panel-content']}>
                            ...
                            <ul className={styles['gwp-globle-menu']}>
                                ...
                                <li className={ classNames( styles['gwp-globle-menu-list'], styles['menu-active'] ) }><label><input type="radio">Buy item X get item Y at Discount Amount off (0)</input></label></li>
