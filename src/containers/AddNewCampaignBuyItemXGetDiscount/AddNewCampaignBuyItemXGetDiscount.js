...
export default class AddNewCampaignBuyItemXGetDiscount extends Component {
    render() {
      const styles = require('./addNewCampaignBuyItemXGetDiscount.scss');
      return (
        <div className="container-fluid">
    		<div className="row">
                <div className={ classNames(styles['item-x-get-discount-percent-view']) }>
                    ...
                    <div className={ styles['panel-right']} >
                        <div className={ styles['panel-content']} >
                            <p className={ styles['list-menu']} >Buy  items X  Get Discount percent off</p>
                            ...
                            <div className={ classNames(styles['control-group'], 'row') }>
                                ...
                                <div className={ classNames(styles['control-optional'], styles['top-border'])}>
                                    <div className={ styles['content-option']} >
                                        <div><label>If you buy Item X <input type="text" className={ styles['small-input']} /> <label>%</label></label>
                                    </div>
                                        <div className={ styles.exceed}>
                                            <label>But not Exceed <input type="text" className={ styles['small-input']} /></label> <label>THB</label></div>
