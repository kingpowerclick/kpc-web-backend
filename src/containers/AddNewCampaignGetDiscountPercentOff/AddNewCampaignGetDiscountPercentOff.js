...
export default class AddNewCampaignGetDiscountPercentOff extends Component {
    render() {
      const styles = require('./addNewCampaignGetDiscountPercentOff.scss');
      return (
        <div className="container-fluid">
    		<div className="row">
                <div className={ classNames(styles['get-discount-percent-off-view']) }>
                            ...
                            <div className={ classNames(styles['control-group'], 'row') }>
                                ...
                                <div className={ classNames(styles['control-optional'], styles['top-border'])}>
                                    <div className={ styles['content-option']} >
                                        <div><label>Buy amount <input type="text" className={ styles['small-input']} /> <label>THB</label></label>
