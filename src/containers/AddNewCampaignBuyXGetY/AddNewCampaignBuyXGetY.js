...
export default class AddNewCampaignBuyXGetY extends Component {
    render() {
      const styles = require('./addNewCampaignBuyXGetY.scss');
      return (
        <div className="container-fluid">
    		<div className="row">
                <div className={ classNames(styles['buy-x-get-y-view']) }>
                            ...
                            <div className={ classNames(styles['control-group'], 'row') }>
                                ...
                                <div className={ classNames(styles['control-optional'], styles['top-border'])}>
                                    <div className={ styles['content-option']} >
                                        <div><label>If you buy Item X Get item Y At Discount <input type="text" className={ styles['small-input']} /> <label>%</label></label>
